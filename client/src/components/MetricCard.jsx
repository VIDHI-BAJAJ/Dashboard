...
export default function MetricCard({ 
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm border border-gray-100 p-6 min-h-[140px] flex flex-col hover:shadow-md transition-shadow duration-200 ${active ? 'bg-blue-50' : ''}`}>
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-2">
          {icon}
          <h3 className="text-sm font-medium text-black tracking-wide">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="text-2xl font-bold text-gray-900 mb-1">
          {value}
           ...
           <span className="text-green-500 text-xs font-medium ml-2">↑ {percentage}%</span>
          )}
        </div>
      </div>
