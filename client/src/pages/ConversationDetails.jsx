...
<div className="border-t border-gray-200 bg-white p-4">
  <div className="max-w-2xl mx-auto">
    <div className="flex items-end border border-gray-300 rounded-lg p-2 bg-gray-50 opacity-70">
      <textarea
        value=""
        onChange={() => {}}
        placeholder="We are working on this..."
        disabled
        className="flex-1 border-0 focus:ring-0 focus:outline-none resize-none py-2 px-3 text-sm bg-transparent text-gray-400 cursor-not-allowed"
        rows="1"
        style={{ minHeight: "40px", maxHeight: "120px" }}
      />
      <button
        disabled
        className="ml-2 px-4 py-2 bg-[#004f98] text-white rounded-lg opacity-50 cursor-not-allowed text-sm"
      >
        Send
      </button>
    </div>
    <p className="text-xs text-center text-gray-400 mt-2">
      Replying via this interface is coming soon.
    </p>
  </div>
</div>
