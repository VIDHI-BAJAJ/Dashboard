      ...
      <div className="bg-white rounded-3xl shadow-2xl flex w-full max-w-3xl overflow-hidden" style={{ minHeight: 560 }}>
        ...
        <div className="bg-gradient-to-r from-[#0f4c8a] to-[#1e6fd9] w-5/12 hidden md:flex flex-col justify-between p-8">
          ...
          <div>
            ...
            The smarter way to manage, track, and close real estate all in one place.
            </h2>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center px-10 py-10">
          ...
          <button
            ...
            className="w-full bg-[#004f98]  hover:bg-[#004f98] hover:text-white disabled:opacity-60 text-white font-semibold py-3 rounded-xl text-sm mb-5 transition"
          >
